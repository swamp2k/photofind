import type { ReviewKeyBindings, ReviewKeymapPreset, ReviewSettingsState } from './ReviewSettings'
...
export function SettingsPanel({ settings, bindings, onAutoAdvance, onKeymap }: SettingsPanelProps): JSX.Element {
  return (
